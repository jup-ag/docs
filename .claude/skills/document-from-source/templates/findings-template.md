...
|---|---------|----------|--------|--------------------|
| 1.1 | <one-line finding> | 🔴/🟡/🟢 | <what you observed, with the concrete evidence: endpoint, error code, signature, what the SDK/FE does instead> | <specific action for the engineers> |
