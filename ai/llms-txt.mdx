...
<Card title="llms.txt" href="https://dev.jup.ag/docs/llms.txt" icon="file" horizontal>
...
- [Get Started](https://dev.jup.ag/docs/get-started/index.md): Welcome to Jupiter's Developer Docs...
- [Overview](https://dev.jup.ag/docs/swap/index.md): One API for all swap use cases on Jupiter.
...
<Card title="llms-full.txt" href="https://dev.jup.ag/docs/llms-full.txt" icon="file" horizontal>
...
```bash
curl https://dev.jup.ag/docs/swap.md
curl https://dev.jup.ag/docs/swap/order-and-execute.md
```

**Method 2: Use the `Accept` header**

```bash
curl -H "Accept: text/markdown" https://dev.jup.ag/docs/swap
```
