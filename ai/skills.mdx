...
Jupiter's documentation also exposes a machine-readable skill file at [`dev.jup.ag/docs/skill.md`](https://dev.jup.ag/docs/skill.md). This is a high-level navigator that points AI agents to the available skills and their capabilities, following the [Mintlify skill.md](https://mintlify.com/docs/ai/skillmd) specification.
