...
| **Recurring** | Set up and manage dollar-cost averaging (DCA) orders that buy at regular intervals. Calls the previous-generation Recurring API; for direct integrations, current DCA lives in the [Trigger API](/trigger/dca). |
