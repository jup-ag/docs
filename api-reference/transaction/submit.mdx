...
description: "Forward a signed transaction to the Solana cluster through Jupiter's landing infrastructure via the tx.jup.ag Solana RPC-compatible endpoint"
