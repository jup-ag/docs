...
- **MEV (Maximal Extractable Value):** profit extracted by reordering, inserting, or censoring transactions on-chain, often at the expense of regular users
...
**What this unlocks:** AI tools get richer, more actionable context for every page without cluttering the human-facing description.
...
Every AI resource mentioned above is derived from the same place: the docs repo.
...
**Expose structured data, not prose alone.** OpenAPI specs, skill definitions, and intent routers give AI tools deterministic paths to the right information. Prose is great for humans. Structured data is what AI can act on.
