...
## Jupiter Lend: DEX Integration Guide

The Jupiter Lend DEX, a concentrated-liquidity AMM on the Liquidity Layer, now has a swap integration guide for routers, aggregators, and on-chain programs.
...
- [DEX Integration overview](/lend/dex)
