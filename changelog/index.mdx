...
## Transaction Submission: tx.jup.ag RPC-compatible endpoint
...
* Same infrastructure that powers Jupiter's swap products (Beam, SWQoS, DoubleZero), now reachable as a drop-in RPC endpoint
