...
**REST API** — Fetch available tokens, positions, and earnings via HTTP. See the [Earn API reference](https://dev.jup.ag/api-reference/lend/earn) for endpoints (`tokens`, `positions`, `earnings`), and request formats.
...
**REST API** — Request unsigned transactions or instructions for deposit, withdraw, mint, and redeem. See the [Earn API reference](https://dev.jup.ag/api-reference/lend/earn) for `deposit`, `withdraw`, `mint`, `redeem` and `deposit-instructions`, `withdraw-instructions`, `mint-instructions`, `redeem-instructions` endpoints.
...
<CardGroup cols={2}>
  <Card title="API reference (Earn)" icon="globe" href="https://dev.jup.ag/api-reference/lend/earn">
  ...
  <Card title="Contracts" icon="github" href="https://github.com/Instadapp/fluid-solana-programs/">
