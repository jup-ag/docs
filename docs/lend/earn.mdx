---
title: "Earn (Beta)"
description: "Deposit and withdraw assets to earn yield through the Jupiter Lend protocol."
llmsDescription: "Jupiter Lend Earn API for depositing and withdrawing assets. Supports deposit/withdraw by amount and mint/redeem by share count, with both transaction and instruction endpoints."
---
