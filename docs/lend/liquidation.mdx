---
title: "Liquidation"
description: "Build a liquidation bot for Jupiter Lend covering fetching liquidations, flash borrowing, and collateral swaps."
llmsDescription: "Build a liquidation bot for Jupiter Lend using the @jup-ag/lend SDK. Covers fetching available liquidations, flash borrowing, executing liquidation instructions, and swapping collateral via Jupiter Swap."
---
