---
title: "Oracles"
description: "Price oracle system for the Jupiter Lend protocol, using Pyth feeds with freshness and confidence validation."
llmsDescription: "Jupiter Lend Oracle Program (jupnw4B6Eqs7ft6rxpzYLJZYSnrpRgPcr589n5Kv4oc) provides price data via a hop-based system using Pyth feeds, with freshness and confidence interval validation."
---
