---
title: "Lend SDK"
description: "TypeScript SDK for integrating with the Jupiter Lend Earn protocol."
llmsDescription: "The @jup-ag/lend SDK provides TypeScript functions for deposit, withdraw, and CPI context accounts to integrate with the Jupiter Lend Earn protocol."
---
