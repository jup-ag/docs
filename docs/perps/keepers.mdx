...
<Note>
Refer to the [Transaction Execution](/docs/perps/transaction-execution) document for more information on how to execute transactions for all operations in Jupiter Perpetuals when using the API.
</Note>
