...
| `pool`                       | **Type:** `publicKey` <br/><br/> The public key of the [JLP pool account](/docs/perps/program/pool-account).                                                                                                                                                                                                                                                                                                                                                                              |
| `custody`                    | **Type:** `publicKey` <br/><br/> The public key of the position's [`custody` account](/docs/perps/program/custody-account).                                                                                                                                                                                                                                                                                                                                                               |
