...
This guide explains how to claim payouts after a prediction market resolves in your favor. Each winning contract is worth \$1.00, and there are no fees for claiming.
...
Each winning contract pays out exactly **\$1.00** (1,000,000 native token units). If you hold 10 YES contracts and the market resolves to YES, your payout is \$10.00.
