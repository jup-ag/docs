...
| Field | Type | Description |
|:------|:-----|:------------|
| `eventMetadata` | object | Parent event metadata: `title`, `subtitle`, `imageUrl`, `isLive`, `slug`, `series`, `closeTime` (ISO 8601) |
| `marketMetadata` | object | Market metadata: `title`, `status`, `result`, `closeTime` (Unix), `openTime`, `rulesPrimary`, `rulesSecondary`, `isTeamMarket` |
