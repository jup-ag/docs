...
sidebarTitle: "V3"
deprecated: true
description: "Overview of Jupiter Price API V3 providing a single source of truth for token prices across all Jupiter UIs and integrator platforms"
llmsDescription: "DEPRECATED — see /docs/price/index for the current Price API documentation. GET /price/v3?ids={mints} returns heuristics-based USD prices for up to 50 token mint addresses per request, using last-swapped price validated against liquidity and trading metrics."
---
