...
llmsDescription: "Jupiter's routing stack: Juno (meta-aggregator) combines Iris (enhanced Metis), JupiterZ (RFQ), and third-party routers for optimal swap execution."
---
