...
llmsDescription: "How markets are listed in Iris routing: instant routing for new markets on supported DEXes with a grace period, and normal routing with liquidity requirements."
---
