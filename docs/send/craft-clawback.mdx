...
description: "Reclaim tokens from an unclaimed Send invite before it expires."
llmsDescription: "Use the POST /send/v1/craft-clawback endpoint to reclaim tokens from an unclaimed Send invite before it expires."
---
