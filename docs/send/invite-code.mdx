...
description: "Generate invite codes and derive deterministic keypairs for the Send API."
llmsDescription: "Client-side utilities for generating 12-character base58 invite codes and deriving deterministic Solana keypairs for the Send API."
---
