...
description: "Launch a token with configurable bonding curves, metadata, and images through the Studio API."
llmsDescription: "Use the Studio API create-tx and submit endpoints to launch a token with configurable bonding curves, upload metadata and images, and submit the signed transaction."
---
