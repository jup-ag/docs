...
The [Build Custom Transactions](/docs/swap/build) code example demonstrates this in steps 4-5 (kit) with full working code.
...
- [Build Custom Transactions](/docs/swap/build) for the full code example with CU simulation
- [Reduce Transaction Size](/docs/swap/advanced/reduce-transaction-size) for other optimisations
