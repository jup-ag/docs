...
See [Other Instructions](/docs/swap/build/other-instructions) for a reference of common instructions.
...
For the full parameter reference, see the [API reference](/api-reference/swap). For how parameters affect routing, see [Routing](/docs/swap/routing).

## Related

- [Other Instructions](/docs/swap/build/other-instructions) for common instructions to compose with your swap
- [Routing](/docs/swap/routing) for how parameters affect routing
- [Fees](/docs/swap/fees) for adding platform fees to `/build`
- [Advanced Techniques](/docs/swap/advanced) for CU simulation, `mode: "fast"`, and `maxAccounts`
