---
title: "Common Errors"
description: "List of errors that can be returned by the Jupiter Metis Swap API, Swap Program or from other programs like DEXes, System or Token programs."
---

In this section, you can find the list of errors that can be returned by the Jupiter Metis Swap API, Swap Program or from other programs like DEXes, System or Token programs.
