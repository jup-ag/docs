...
<Note>
  Adding optional parameters to `/order` (such as fee or slippage overrides) may restrict routing. See [Routing](/docs/swap/v2/routing) for details.
</Note>
...
- [Routing](/docs/swap/v2/routing) for the routing impact matrix
