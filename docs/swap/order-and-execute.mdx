...
<Note>
  Adding optional parameters to `/order` (such as fee or slippage overrides) may restrict routing. See [Routing](/docs/swap/routing) for details.
</Note>
...
For the full parameter reference and how each parameter affects routing, see [Routing](/docs/swap/routing).
...
- [Routing](/docs/swap/routing) for optional parameters and their routing impact
- [Fees](/docs/swap/fees) for adding integrator fees to `/order`
