...
llmsDescription: "DEPRECATED — use Swap API V2 instead. POST /swap/v1/swap builds a serialized swap transaction from a quote. Supports dynamicComputeUnitLimit, dynamicSlippage, and prioritizationFeeLamports."
deprecated: true
---
