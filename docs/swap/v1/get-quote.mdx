...
llmsDescription: "DEPRECATED — use Swap API V2 instead. GET /swap/v1/quote returns route plans from the Metis routing engine. Required params: inputMint, outputMint, amount, slippageBps."
deprecated: true
---
