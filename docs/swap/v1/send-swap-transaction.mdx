...
llmsDescription: "DEPRECATED — use Swap API V2 instead. Sign and send the serialized Metis swap transaction via your own RPC. Covers priority fee estimation, compute unit limits, dynamic slippage, and Jito broadcasting."
deprecated: true
---
