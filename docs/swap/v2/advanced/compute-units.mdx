...
The [Build Custom Transactions](/docs/swap/v2/build) code example demonstrates this in steps 4-5 (kit) with full working code.
...
- [Build Custom Transactions](/docs/swap/v2/build) for the full code example with CU simulation
