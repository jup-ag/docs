...
const secretKey = bs58.decode(process.env.BS58_PRIVATE_KEY!);
...
const orderResponse = await fetch(
  `${BASE_URL}/order?` +
    new URLSearchParams({
      ...
      excludeRouters: "metis,okx,dflow,hashflow",
    }),
...
// Step 3: Execute
const signedTxBytes = getTransactionEncoder().encode(
...
- Jupiter Beam for accelerated transaction sending and landing across multiple RPC providers
