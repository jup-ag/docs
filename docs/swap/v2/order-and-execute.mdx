...
| `taker` | Your wallet address. Required to receive an assembled transaction. |
...
- Transaction landing via optimised RPC infrastructure
- Confirmation polling
- Retry on transient failures
- RTSE (Real-Time Swap Execution) for aggregator swaps
- Jupiter Beam for accelerated landing
...
| `-1` | Ultra | Missing cached order (requestId not found or expired) |
