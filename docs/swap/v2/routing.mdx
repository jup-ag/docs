...
- [Fees](/docs/swap/v2/fees) for fee models and how referral fees affect routing
- [Gasless Swaps](/docs/swap/v2/advanced/gasless) for how `payer` affects routing
- [Order & Execute](/docs/swap/v2/order-and-execute) for the default swap flow
- [API Reference: GET /order](/api-reference/swap/v2/order) for the full parameter specification
