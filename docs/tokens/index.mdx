---
title: "Token Verification and Listing"
sidebarTitle: "About Tokens"
description: "Understand how tokens are listed and verified on Jupiter."
llmsDescription: "Jupiter's token verification system, listing process, and search APIs. Use the V2 API for programmatic token discovery and metadata."
---
...
* [Ecosystem Token List V2: Catdet List](https://catdetlist.jup.ag): Maintained by Catdets and community with simple metrics to aid review.
    - [Article](https://www.jupresear.ch/t/ecosystem-master-token-list/19786) on the background and history of the Ecosystem Token List V2
* **Ecosystem Token List V3: Verify**:
    - [Introduction post](https://x.com/9yointern/status/1907425355071197347) on the formation of verify.jup.ag (site no longer available)
