---
title: "Tokens API V2"
sidebarTitle: "Token Information"
description: "Guide on Tokens V2 API endpoints to query for mint information in specific searches, tags or categories."
llmsDescription: "GET /tokens/v2 endpoints for retrieving token metadata by mint address, symbol search, tag, category, or recency. Returns name, symbol, icon, organic score, holder count, and trading stats."
---
...
<Tip>
  ...
  * [Organic Score](/docs/tokens), Holder count, Market cap, etc can be useful to help make a better trading decision
  * And much more!
