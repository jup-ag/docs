...
description: "Use the token tag standard to get your tokens tagged for better visibility on Jupiter UI or via the Tokens API."
llmsDescription: "Token tags categorize tokens in the Jupiter Tokens API (e.g., Verified, LST). Projects can apply for custom tags by providing a public CSV endpoint of mint addresses."
---
