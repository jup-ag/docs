...
The Content API operates through a curated content system powered by [Jupiter Verify](https://verified.jup.ag/):

1. **Content Submission**: Content is submitted by verified users through [Jupiter Verify](https://verified.jup.ag/), Jupiter's content verification platform
...
Content provided through the Content API is curated and verified by [Jupiter Verify](https://verified.jup.ag/). All content includes attribution information:
...
When displaying content from this API, please maintain proper attribution to [Jupiter Verify](https://verified.jup.ag/) and the original content sources as provided in the response data.
