...
llmsDescription: "POST /trigger/v1/execute submits a filled trigger order. Jupiter automatically monitors and executes orders when the target price is reached."
---
