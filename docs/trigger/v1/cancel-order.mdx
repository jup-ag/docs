---
title: "Cancel Order"
description: "Cancel an open trigger order and reclaim unfilled tokens."
llmsDescription: "UNMAINTAINED: POST /trigger/v1/cancelOrder cancels a single open trigger order. POST /trigger/v1/cancelOrders cancels multiple orders in batched transactions (groups of 5). Both return unfilled tokens to the maker."
---
...
<Note>
  **GET TRIGGER ORDERS**
  ...
  [Refer to the `/getTriggerOrders` section](/docs/trigger/v1/get-trigger-orders) to prepare the list of order accounts you want to cancel.
</Note>
