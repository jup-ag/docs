---
title: "Execute Order"
description: "Submit a signed trigger order transaction for on-chain execution."
llmsDescription: "UNMAINTAINED: POST /trigger/v1/execute submits a signed trigger order transaction for on-chain execution. Covers signing with web3.js v1, using the /execute endpoint, and sending the transaction yourself."
---
