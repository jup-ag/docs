...
description: "Query active and historical trigger orders by wallet, status, or token pair."
llmsDescription: "UNMAINTAINED: GET /trigger/v1/getTriggerOrders returns paginated active and historical trigger orders filtered by wallet (user), orderStatus (active/history), and optional token mint addresses."
---
