...
1. [**Create Order**](/docs/trigger/v1/create-order): Create a new trigger order with your desired parameters.
2. [**Execute Order**](/docs/trigger/v1/execute-order): Execute a trigger order.
3. [**Cancel Order**](/docs/trigger/v1/cancel-order): Cancel an existing trigger order.
4. [**Get Trigger Orders**](/docs/trigger/v1/get-trigger-orders): Retrieve active/historical trigger orders for a specific wallet address
5. [**Best Practices**](/docs/trigger/v1/best-practices): Best practices for using Trigger API.
