...
llmsDescription: "DEPRECATED — use Swap API V2 instead. Ultra Swap charges 5–10 bps per swap. Integrators can add custom fees (Jupiter takes 20% of integrator fees). Fee mint is determined by a priority list."
deprecated: true
---
