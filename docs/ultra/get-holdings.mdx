...
llmsDescription: "DEPRECATED — use Swap API V2 instead. GET /ultra/v1/holdings/{address} returns detailed token holdings including token account info, frozen status, and native SOL balance."
deprecated: true
---
