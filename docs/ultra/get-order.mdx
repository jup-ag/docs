...
llmsDescription: "DEPRECATED — use Swap API V2 instead. GET /ultra/v1/order returns a base64-encoded unsigned swap transaction. Required params: inputMint, outputMint, amount, taker."
deprecated: true
---
