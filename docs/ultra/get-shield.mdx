...
llmsDescription: "DEPRECATED — use Swap API V2 instead. GET /ultra/v1/shield?mints={mints} returns token security warnings (freeze authority, mint authority, low organic activity, etc.) for specified mint addresses."
deprecated: true
---
