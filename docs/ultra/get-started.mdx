...
llmsDescription: "DEPRECATED — use Swap API V2 instead. Two-step swap flow: call GET /order to get a transaction, sign it, then POST /execute. Includes links to all Ultra endpoints and guides."
deprecated: true
---
