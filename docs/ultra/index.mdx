...
llmsDescription: "DEPRECATED — use Swap API V2 instead. Ultra Swap API overview covering RPC-less, gasless swap flow with automatic slippage optimisation and sub-second transaction landing. Superseded by Swap API V2 at api.jup.ag/swap/v2."
deprecated: true
---
