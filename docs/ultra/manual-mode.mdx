...
llmsDescription: "DEPRECATED — use Swap API V2 instead. Use manual mode to control Ultra API parameters like slippage or priority fee settings. Not recommended for default integrations — use only for user-facing trading UIs."
deprecated: true
---
