...
<aside>
<img src="/icons/exclamation-mark-double_pink.svg" alt="/icons/exclamation-mark-double_pink.svg" width="40px" />
...
Manual mode is not guaranteed stable or supported API usage. As it may subject to changes as Ultra evolves.
