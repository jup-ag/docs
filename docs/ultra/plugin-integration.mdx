...
llmsDescription: "Drop-in Ultra Swap UI widget for any web app. Three display modes (integrated, widget, modal), wallet passthrough support, and integrator fee configuration."
---
