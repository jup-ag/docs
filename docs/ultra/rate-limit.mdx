...
llmsDescription: "DEPRECATED — use Swap API V2 instead. Ultra Swap API uses dynamic rate limiting: 50 base requests per 10-second window, scaling with executed swap volume. Free API key required from portal.jup.ag."
deprecated: true
---
