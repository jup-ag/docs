---
title: "Search Token"
description: "Search for tokens by symbol, name, or mint address through the Ultra Swap API."
llmsDescription: "DEPRECATED — use Swap API V2 instead. GET /ultra/v1/search?query={query} returns token metadata by symbol, name, or mint address. Supports comma-separated queries, up to 100 mints."
deprecated: true
---
