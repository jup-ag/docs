...
llmsDescription: "Welcome page for Jupiter Developer Docs. Introduces Jupiter as Solana DeFi infrastructure and provides quick navigation to product APIs (Swap, Tokens, Price, Lend, LO & DCA, Prediction, Perps), developer resources (Guides, API Reference, Developer Platform), AI resources (CLI, Skills, MCP, llms.txt), community links, socials (Blog and X), and get-started setup pages."
---
...
<CardGroup cols={2}>
  ...
  <Card title="LO & DCA" icon="crosshairs" href="/trigger">
    Vault-based limit orders (single, OCO, OTOCO) and DCA (time-based and price-conditional).
  </Card>
