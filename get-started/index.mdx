...
### Routing Engine
<CardGroup cols={2}>
    <Card title="Metis" icon="split" href="/docs/routing/dex-integration" horizontal>
        DEX routing engine consisting of 70+ DEXes and growing
    </Card>
    <Card title="JupiterZ (RFQ)" icon="arrow-right" href="/docs/rfq-integration" horizontal>
        RFQ (Request For Quote) routing engine consisting of 20+ market makers and growing
    </Card>
</CardGroup>
