...
<Card title="Browse All Guides" icon="code" href="/guides">
    Library of all API, SDK and all developer resource guides.
</Card>
<Card title="Browse All Products" icon="book" href="/docs/swap">
    View all product documentation and API reference.
</Card>
<Card title="Browse All AI Tools" icon="robot" href="/ai">
    Leverage AI tools.
</Card>
