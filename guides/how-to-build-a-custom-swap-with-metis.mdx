...
async function swap(inputMint, outputMint, amount, slippageBps) {
  ...
  try {
    ...
    if (quoteResponse.error) {
      console.error('Quote failed:', { url: quoteUrl, response: quoteResponse });
    ...
    if (swapResponse.error) {
      console.error('Swap build failed:', { quoteUrl, swapPayload, response: swapResponse });
    ...
    console.error('Swap error:', { quoteUrl, error: error.message });
    throw error;
  }
}
```
