...
For the full list of parameters (`destinationTokenAccount`, `nativeDestinationAccount`, `trackingAccount`, `asLegacyTransaction`, `blockhashSlotsToExpiry`, and more), see the [Swap API Reference](/api-reference/swap/swap).
...
- **[Send Swap Transaction](/docs/swap/send-swap-transaction).** Deep dive into priority fees, compute units, and transaction broadcasting.
- **[Common Errors](/docs/swap/common-errors).** Full error reference for the Metis Swap API and swap program.
