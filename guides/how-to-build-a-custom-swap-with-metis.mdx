...
<Warning>
Metis Swap V1 is deprecated. Use [Swap API V2 /build](/swap/build/index) instead - it replaces `/quote` + `/swap-instructions` with a single `/build` endpoint. See the [Migration Guide](/swap/migration).
</Warning>
