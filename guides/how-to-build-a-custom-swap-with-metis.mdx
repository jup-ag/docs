...
<AccordionGroup>
  <Accordion title="During quoting">
    ...
    |-------|---------------|------------|
    | `NO_ROUTES_FOUND` / `COULD_NOT_FIND_ANY_ROUTE` | No liquidity path exists | Check if the token is tradeable on [jup.ag](https://jup.ag). See [Market Listing](/swap/routing/amm/market-listing) for the grace period and liquidity criteria |
...
- **[Integrate AMM into Metis](/swap/routing/amm/integration).** How tokens and markets get listed in Jupiter's routing engine.
