...
To charge a fee on swaps through your integration, pass `platformFeeBps` in the quote and `feeAccount` in the swap. See [Add Fees to Swap](/docs/swap/add-fees-to-swap) for the full setup walkthrough.
