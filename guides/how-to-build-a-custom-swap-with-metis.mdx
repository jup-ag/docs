...
<Warning>
Metis Swap V1 is deprecated. Use [Swap API V2 /build](/docs/swap/build/index) instead - it replaces `/quote` + `/swap-instructions` with a single `/build` endpoint. See the [Migration Guide](/docs/swap/migration).
</Warning>
...
For the full list of parameters, see the [Swap API Reference](/api-reference/swap/swap).
...
Priority fees, compute units, slippage, and your RPC setup all affect whether transactions land. For the full deep dive, see [Send Swap Transaction](/docs/swap/send-swap-transaction).
...
<AccordionGroup>
  <Accordion title="Priority fees">
    ...
    See [how Jupiter estimates priority fees](/docs/swap/send-swap-transaction#how-jupiter-estimates-priority-fee).
  </Accordion>
  ...
  <Accordion title="Compute units">
    ...
    See [how Jupiter estimates compute unit limit](/docs/swap/send-swap-transaction#how-jupiter-estimates-compute-unit-limit).
  </Accordion>
  ...
  <Accordion title="Slippage">
    ...
    See [how Jupiter estimates slippage](/docs/swap/send-swap-transaction#how-jupiter-estimates-slippage).
  </Accordion>
  ...
  <Accordion title="RPC and broadcasting">
    ...
    See [how Jupiter broadcasts transactions](/docs/swap/send-swap-transaction#how-jupiter-broadcast-transactions).
  </Accordion>
</AccordionGroup>
...
- **[Add Fees to Swap](/docs/swap/add-fees-to-swap).** Collect platform fees on swaps through your integration.
- **[Swap API Reference](/api-reference/swap).** Full endpoint schema and playground.
- **[Market Listing](/docs/routing/market-listing).** How tokens and markets get listed in Jupiter's routing engine.
