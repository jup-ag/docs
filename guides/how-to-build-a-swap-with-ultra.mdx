...
<AccordionGroup>
  ...
  <Accordion title="What's the rate limit?">
    Dynamic. Base is 50 requests per 10-second sliding window, and it scales up with your swap volume. $1M in daily volume gets you ~165 req/10s. No paid tiers. Just get a free API key at [portal.jup.ag](https://portal.jup.ag). Details: [Rate Limits](/ultra/rate-limit).
  </Accordion>
