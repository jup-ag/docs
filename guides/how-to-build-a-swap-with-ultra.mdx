...
Done. Your swap lands in 50-400ms via [Jupiter Beam](https://developers.jup.ag/blog/ultra-v3#sub-second-transaction-landing).
...
**JupiterZ (RFQ).** When a market maker provides the route, the market maker pays network and priority fees. If the output token account does not exist, Jupiter's gas wallet funds its creation.
...
- **[Ultra V3 Blog](https://developers.jup.ag/blog/ultra-v3).** What makes Ultra the best execution engine on Solana.
