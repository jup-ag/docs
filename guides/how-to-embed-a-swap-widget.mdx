...
<Tip>
**Video walkthrough + example code:** Watch the [video walkthrough](https://x.com/JupDevRel/status/2033528378134028756) and grab the [example code](https://github.com/jup-ag/api-examples/tree/main/apps/plugin-community-site) on GitHub.
</Tip>
