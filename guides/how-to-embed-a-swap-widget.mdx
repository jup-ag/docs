...
You don't need any development tools. Just a browser and a text editor.
...
4. Find the file on your computer and double-click it — it opens in your browser
5. You should see a floating swap widget in the corner of the page
...
The [Plugin Playground](https://plugin.jup.ag/) lets you configure and preview the widget in real time. You can:

- Switch between display modes (integrated, widget, modal)
- Set form props like initial tokens and fixed mints
- Customise the colour theme to match your brand
- Copy the generated configuration code directly into your project

Use it to experiment before writing any code, or to fine-tune your configuration visually.
