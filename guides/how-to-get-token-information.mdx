...
<AccordionGroup>
  ...
  <Accordion title="What does organic score mean?">
    Organic score (0-100) measures real trading activity vs wash trading. Higher = more legitimate trading. See [Organic Score docs](/docs/tokens) for methodology.
  </Accordion>
...
- **[Tokens API Reference](/api-reference/tokens)** — Full endpoint schemas
- **[Organic Score](/docs/tokens)** — Scoring methodology
