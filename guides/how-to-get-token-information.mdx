...
<Tip>
**Video walkthrough + example code:** Watch the [video walkthrough](https://x.com/JupDevRel/status/2031184726820794624) and grab the [example code](https://github.com/jup-ag/api-examples/tree/main/apps/tokens-api) on GitHub.
</Tip>
