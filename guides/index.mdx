...
All guide examples are available as complete, runnable apps in the [api-examples repo](https://github.com/jup-ag/api-examples):

- [Plugin community site](https://github.com/jup-ag/api-examples/tree/main/apps/plugin-community-site)
- [Prediction API demo](https://github.com/jup-ag/api-examples/tree/main/apps/prediction-API-video-demo)
