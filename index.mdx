...
description: "Build with the most comprehensive set of APIs, tool kits and technical deep dives across Jupiter's full product suite, from Ultra Swap, Lend, Perps and beyond."
---
    ...
    <div className="text-center max-w-6xl mx-auto pt-8 sm:pt-0">
      ...
      <div className="mx-1 md:mx-20 grid grid-cols-3 md:grid-cols-3 gap-2 md:gap-6 p-2 md:p-6">
        ...
        <div className="bg-gradient-to-br from-[#00BEF0]/10 to-[#C7F284]/10 border border-[#00BEF0]/10 rounded-lg md:rounded-xl p-3 md:p-6 text-center ">
          <div className="text-xl md:text-3xl font-bold text-[#00BEF0] dark:text-[#C7F284] mb-1 md:mb-2">$2T+</div>
  ...
  <div className="max-w-6xl mx-auto pt-[60px] md:pt-[120px] pb-[60px] md:pb-[120px] relative px-4">
    ...
    <Card title="Core Products" icon="diamonds-4">
      ...
      <Columns cols={2}>
        ...
        <Card title="Prediction Market" icon="check-to-slot" href="/docs/prediction-market" horizontal>
            Predict events
        </Card>
        ...
        <Card title="Portfolio" icon="wallet" href="/docs/portfolio" horizontal>
