...
<Card title="Privacy Policy File" href="https://github.com/jup-ag/docs/tree/main/static/files/legal/privacy-policy-2024.pdf" icon="link" iconType="solid" horizontal/>
