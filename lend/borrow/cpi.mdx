...
For TypeScript SDK integration (off-chain), see [Create Position](/lend/borrow/create-position), [Deposit](/lend/borrow/deposit), [Borrow](/lend/borrow/borrow), [Repay](/lend/borrow/repay), and [Withdraw](/lend/borrow/withdraw).
