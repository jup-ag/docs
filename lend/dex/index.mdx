...
The Jupiter Lend DEX is a concentrated-liquidity AMM that runs on top of the Jupiter Lend Liquidity Layer. The Jupiter routing engine already routes through it. This guide is for routers, aggregators, and on-chain programs that want to swap against the DEX directly.
