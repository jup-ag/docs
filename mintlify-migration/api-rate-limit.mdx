...
description: "In this section, you can find the rate limiting details for the Jupiter API."
---
...
The [**Ultra API**](/ultra-api) uses a unique rate limiting mechanism that scales with your **executed swap volume** over time.
