---
title: "API FAQ"
description: "This section covers the FAQ of the API Key set up and rate limits systems. Please read [API Setup](/api-setup) and [API Rate Limit](/api-rate-limit) docs as well."
---
