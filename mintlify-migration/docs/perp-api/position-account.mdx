...
| `pool`                       | **Type:** `publicKey` <br/><br/> The public key of the [JLP pool account](/docs/perp-api/pool-account).                                                                                                                                                                                                                                                                                                                                                                              |
| `custody`                    | **Type:** `publicKey` <br/><br/> The public key of the position's [`custody` account](/docs/perp-api/custody-account).                                                                                                                                                                                                                                                                                                                                                               |
