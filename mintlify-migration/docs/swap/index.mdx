...
* [**Adding Fees to Legacy Swap API**](/docs/swap-api/add-fees-to-swap): Add custom integrator fees to the swap transaction.
* [**Using Legacy Swap API as a payment method**](/docs/swap-api/payments-through-swap): Use Legacy Swap API as a payment method for your users.
