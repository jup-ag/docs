---
title: "s API V1 (Deprecated)"
description: "In this guide, we will be going through a few examples of what Tokens API endpoints you can call to get the information you need."
