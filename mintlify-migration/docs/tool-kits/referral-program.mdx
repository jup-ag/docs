...
description: "The Referral Program is an open-source program used by Jupiter Programs (or any other programs) to enable developers to earn fees."
---
...
- [Add Fees to Ultra API](/docs/ultra-api/add-fees-to-ultra): To add fees to your Ultra API integration.
- [Add Fees to Swap and Trigger API](/docs/swap-api/add-fees-to-swap): To add fees to your Swap and Trigger API integration.
- [Add Fees to Jupiter Plugin](/docs/tool-kits/plugin#adding-fees-to-plugin): To add fees to your Plugin integration.
