...
| --- | --- | --- | --- | --- |
| **Iris** | ✅ Yes | ✅ Yes | ✅ Yes | - Minimum trade size of 10 USD<br/>- Gas is taken from swap amount, meaning more fees taken from user |
...
<Warning>
Note that Iris's Gasless Support mechanism only kicks in when user has insufficient SOL.
</Warning>

| User Scenario | Iris (Gasless Support) | JupiterZ | Others |
| --- | --- | --- | --- |
