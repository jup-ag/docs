...
<Accordion title="Reduction of minimum trade size">
    Currently, it requires at least 10 USD of swap size to be applicable for Gasless Support.
</Accordion>

<Accordion title="Sponsoring of ATA rent is inconsistent">
    Currently, only Metis covers ATA creation. JupiterZ **might** support ATA coverage in the future.
</Accordion>

<Accordion title="`payer={integratorGasPayer}` parameter">
    <Note>
        Refer to [`payer`](/docs/ultra/payer) for more details.
    </Note>
</Accordion>
