...
<Tip>
  **API REFERENCE**
  ...
  To fully utilize the Ultra API, check out the [Ultra API Reference](/api-reference/ultra/shield).
</Tip>
...
For the full list of potential warnings, refer to the [Shield API Reference](/api/ultra-api/shield).
