...
<Tip>
  **API REFERENCE**
  ...
  To fully utilize the Ultra API, check out the [Ultra API Reference](/api-reference/ultra/search).
</Tip>
...
<Tip>
  ...
  * And much more!
  ...
  Refer to [Ultra API Reference](/api/ultra-api/search) for full schema.
</Tip>
