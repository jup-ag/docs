---
title: "Search Token"
descripton: "Ultra Swap API to search tokens and their information by mint, name or symbol."
---
...
<Tip>
  ...
  * And much more!
  ...
  Refer to [Ultra API Reference](/api-reference/ultra/search) for full schema.
</Tip>
