    ...
    **Why Choose Ultra Swap?**
    ...
    <Note>
        **New to Jupiter, Solana or blockchain development?**    
        ...
        Whether you’re new to Solana or a seasoned developer, Ultra Swap API was created for all skill levels. It handles all of the complexities of blockchain development while providing you with the same performance and reliability that you experience on [jup.ag](https://jup.ag).
    </Note>
</Card>
