...
<div className="relative min-h-screen text-[#181D27] dark:text-[#F9F9FB]">
  ...
  <div className="flex flex-col items-center justify-center pt-[60px] md:pt-[120px] pb-[60px] md:pb-[120px] relative px-4">
    <div className="text-center max-w-6xl mx-auto pt-8 sm:pt-0">
      <div className="text-center justify-start text-xs sm:text-base text-[#00BEF0] dark:text-[#C7F284] font-medium leading-normal">Welcome to Jupiter's Developer Documentation!</div>
      ...
      <div className="mx-1 md:mx-20 grid grid-cols-3 md:grid-cols-3 gap-2 md:gap-6 p-2 md:p-6">
        <div className="bg-gradient-to-br from-[#C7F284]/10 to-[#00BEF0]/10 border border-[#00BEF0]/10 rounded-lg md:rounded-xl p-3 md:p-6 text-center hover:border-[#00BEF0]/40">
          ...
          <div className="text-xs md:text-sm text-gray-600 dark:text-gray-400 hidden md:block">Leading DeFi across all chains</div>
        </div>
        <div className="bg-gradient-to-br from-[#00BEF0]/10 to-[#C7F284]/10 border border-[#00BEF0]/10 rounded-lg md:rounded-xl p-3 md:p-6 text-center hover:border-[#00BEF0]/40">
  ...
  <div className="max-w-6xl mx-auto pt-[60px] md:pt-[120px] pb-[60px] md:pb-[120px] relative px-4">
    ...
    <div className="flex justify-center text-[#535862] dark:text-[#A6A09E] text-xs sm:text-lg font-normal leading-6 sm:leading-7 pb-[40px] sm:pb-[56px] text-center">The perfect swap experience for everyone everywhere</div>
            ...
            <Card title="Why Ultra Swap?">
              <div className="space-y-3 mt-4">
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 rounded-full bg-[#00BEF0]"></div>
                  <div className="font-normal text-sm text-gray-600 dark:text-gray-400">Does not require RPCs.</div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 rounded-full bg-[#00BEF0]"></div>
                  <div className="font-normal text-sm text-gray-600 dark:text-gray-400">Handles slippage & priority fee optimizations.</div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 rounded-full bg-[#00BEF0]"></div>
                  <div className="font-normal text-sm text-gray-600 dark:text-gray-400">Handles transaction sending & polling.</div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 rounded-full bg-[#00BEF0]"></div>
                  <div className="font-normal text-sm text-gray-600 dark:text-gray-400">Lowest MEV with fast execution & high success.</div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 rounded-full bg-[#00BEF0]"></div>
                  <div className="font-normal text-sm text-gray-600 dark:text-gray-400">Multiple liquidity sources & gasless support.</div>
                </div>
              </div>
            </Card>
  ...
  <div className="max-w-6xl mx-auto pt-[60px] md:pt-[120px] pb-[60px] md:pb-[120px] relative px-4">
    <div className="flex justify-center text-2xl sm:text-3xl md:text-4xl font-bold leading-tight md:leading-10 pb-[10px]">Developer Products</div>
    ...
    <CardGroup cols={2}>
      <Card title="Core Products" icon="diamonds-4">
        ...
        <Columns cols={2}>
          <Card title="Ultra Swap" href="/docs/ultra" icon="bolt" horizontal/>
          <Card title="Lend" href="/docs/lend" icon="piggy-bank" horizontal/>
          <Card title="Perp" href="/docs/perp" icon="chart-line" horizontal/>
          <Card title="Studio" href="/docs/studio" icon="building-columns"  horizontal/>
          <Card title="Trigger" href="/docs/trigger" icon="bullseye"  horizontal/>
          <Card title="Recurring" href="/docs/recurring" icon="clock-rotate-left"  horizontal/>
        </Columns>
      </Card>

      <Card title="Other Products" icon="ethernet">
        Utilize additional products to enhance your DeFi superapp.
        <Columns cols={2}>
          <Card title="Tokens" href="/docs/tokens" icon="coin" horizontal/>
          <Card title="Price" href="/docs/price" icon="dollar-sign" horizontal/>
          <Card title="Send" href="/docs/send" icon="paper-plane" horizontal/>
        </Columns>
      </Card>
      ...
      <Card title="Tool Kits" icon="toolbox">
        ...
        <Columns cols={1}>
          ...
          <Card title="Mobile Wallet Adapter" href="/tool-kits/mobile-adapter" icon="mobile" horizontal>
      ...
      <Card title="Routing" icon="split">
        ...
        <Columns cols={1}>
          <Card title="For DEXes" href="/routing/dex-integration" icon="split" horizontal>
            Integrate your DEX into Jupiter's Metis routing engine.
          </Card>
          <Card title="For MMs" href="/routing/rfq-integration" icon="arrow-right" horizontal> 
  ...
  <div className="max-w-6xl mx-auto pt-[60px] md:pt-[120px] pb-[60px] md:pb-[120px] relative px-4">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
      ...
      <div>
        ...
        <div className="flex justify-center lg:justify-start text-[#535862] dark:text-[#A6A09E] text-xs sm:text-sm font-normal leading-6 pb-[30px] text-center lg:text-left">Liquidity venues integrated into Metis and JupiterZ</div>
