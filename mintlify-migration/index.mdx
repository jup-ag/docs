  ...
  <div className="max-w-6xl mx-auto pt-[60px] md:pt-[120px] pb-[60px] md:pb-[120px] relative px-4">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
      ...
      <div>
        ...
        <div className="flex justify-center lg:justify-start text-[#535862] dark:text-[#A6A09E] text-xs sm:text-sm font-normal leading-6 pb-[30px] text-center lg:text-left">Liquidity venues integrated into Iris</div>
