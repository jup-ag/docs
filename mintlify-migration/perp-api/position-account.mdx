...
| `pool`                       | **Type:** `publicKey` <br/><br/> The public key of the [JLP pool account](/perp-api/pool-account).                                                                                                                                                                                                                                                                                                                                                                              |
| `custody`                    | **Type:** `publicKey` <br/><br/> The public key of the position's [`custody` account](/perp-api/custody-account).                                                                                                                                                                                                                                                                                                                                                               |
