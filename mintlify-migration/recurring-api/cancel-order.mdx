...
<Note>
  **GET RECURRING ORDERS**
  ...
  [Refer to the `/getRecurringOrders` section](/recurring-api/get-recurring-orders) to prepare the list of order accounts you want to cancel.
</Note>
...
Refer to the [Execute Order](/recurring-api/execute-order) section for more details.
