...
<Tip>
  **TIP**
  ...
  Depending on how you have set up to allow connection of wallets, either via [Jupiter Mobile Adapter](/tool-kits/mobile-adapter) for QR code login, wallet extensions, or any other methods, you will need to handle the passing in of their pubkey to the API to get the necessary data.
</Tip>
