---
title: "Studio API"
description: "Studio is built for culture architects who want:"
---
...
* You are required to make a PUT request to those endpoints, [you can refer to this section on the usage](/studio-api/create-token#token-metadata).
