...
In this guide, we will pick up from where [**Get Quote**](/swap-api/get-quote) guide has left off.
...
<Tip>
  **API REFERENCE**
  ...
  To fully utilize the Swap API, check out the [Swap API or Swap Instructions Reference](/api-reference/swap-api/swap).
</Tip>
...
<Tip>
  **OPTIMIZING FOR TRANSACTION LANDING IS SUPER SUPER IMPORTANT!**
  ...
  To understand how these parameters help, the next step, [Send Swap Transaction guide](/swap-api/send-swap-transaction) will discuss them.
</Tip>
...
<Info>
  **NOTE**
  ...
  [Refer to the GET /quote's `maxAccounts` guide for more details.](/swap-api/get-quote#max-accounts)
</Info>
