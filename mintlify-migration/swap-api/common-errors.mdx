---
title: "Common Errors"
description: "In this section, you can find the list of errors that can be returned by the Jupiter Swap API, Swap Program or from other programs like DEXes, System or Token programs."
---
...
| :--------- | :------------------------ | :------------------------------------------------------------------------------------------------------------------------- |
| 6001       | SlippageToleranceExceeded | Try higher fixed slippage or try [`dynamicSlippage`](/swap-api/send-swap-transaction#how-jupiter-estimates-slippage) |
