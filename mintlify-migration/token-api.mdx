...
<Warning>
  **DEPRECATED**
  ...
  [Token API V1](/token-api/v1) will be/is deprecated by 1 August 2025.

  Please migrate to [Token API V2](/token-api/v2) which consists of breaking changes.
</Warning>
...
* [Ecosystem Token List V3: Verify](https://verify.jup.ag): Using a variety of trading, social metrics and [Organic Score](/token-api/organic-score) to aid verification.
