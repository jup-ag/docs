...
description: "In this guide, we will be going through a few examples of what Token API endpoints you can call to get the information you need."
...
<Info>
  **NOTE**
  ...
  For higher rate limits, [refer to the API Key Setup doc](/api-setup).
</Info>
