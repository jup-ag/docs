...
- [**Jupiter Plugin**](/tool-kits/plugin/): A ready-to-use swap interface that can be embedded into any website.
- [**Jupiter Mobile Adapter**](/tool-kits/mobile-adapter): A wallet interface to allow Jupiter Mobile QR code login.
- [**Unified Wallet Kit**](/tool-kits/wallet-kit/): A wallet interface that can be embedded into any website.
