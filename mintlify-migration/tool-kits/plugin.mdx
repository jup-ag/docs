...
---
<Frame>
![Jupiter Plugin Hero](https://dev.jup.ag/assets/images/plugin-f5718e4d9570c2e918c0c352cb6ba3be.png)
</Frame>
...
- **Ultra Mode**: Access to all features of Ultra Mode, read more about it in the [Ultra API docs](/ultra-api/).
...
- **Referral Account**: You can create a referral account via [scripts](/ultra-api/add-fees-to-ultra) or [Referral Dashboard](https://referral.jup.ag/).
