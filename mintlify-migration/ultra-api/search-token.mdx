...
<Tip>
  **API REFERENCE**
  ...
  To fully utilize the Ultra API, check out the [Ultra API Reference](/api-reference/ultra-api/search).
</Tip>
...
<Tip>
  ...
  * And much more!
  ...
  Refer to [Ultra API Reference](/api-reference/ultra-api/search) for full schema.
</Tip>
