...
API keys belong to a team. You can create and manage a team's keys if you are a member of that team, or an owner or admin of the organisation. See [Organisations & Teams](/portal/organizations) for who can manage what.
...
The **Swap** permission also covers `/ultra/v1/*` and `/tx/v1/submit`, so a key limited to Swap can reach those paths too.
