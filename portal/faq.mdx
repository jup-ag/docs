...
<AccordionGroup>
  ...
  <Accordion title="Who can see my team's data and keys?">
    Everyone in your organization can view every team's analytics and request logs, read-only. Only members of a team, and organization owners and admins, can create or manage that team's API keys and firewall rules. See [Organizations & Teams](/portal/organizations).
  </Accordion>
