...
<AccordionGroup>
  ...
  <Accordion title="Do all API requests share the same rate limit?">
    Most do. Swap, Price, and Token requests share the same bucket. However, `/swap/v2/execute` has its own dedicated bucket. See [Rate Limits](/portal/rate-limits#buckets) for the full breakdown.
  </Accordion>
