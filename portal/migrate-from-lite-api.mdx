...
description: "Migrate from the deprecated lite-api.jup.ag to api.jup.ag with a free API key."
llmsDescription: "Migrate from lite-api.jup.ag to api.jup.ag: update the base URL, generate a free API key at portal.jup.ag, and add the x-api-key header."
---
