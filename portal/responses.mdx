...
This page lists the common HTTP response codes returned by Jupiter APIs and provides debugging guidance for each. Codes range from 200 (success) through 400-level client errors (bad request, unauthorized, rate limited) to 500-level server errors.
