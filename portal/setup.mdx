...
<Tip>
You can also make requests without an API key at 0.5 RPS. Adding a free API key doubles your rate limit to 1 RPS.
</Tip>
...
If you had an account on the old Jupiter Portal, your API keys are preserved. See the [Migration Guide](/portal/migration) for details on setting up your legacy organisation and the 3-month grace period.
