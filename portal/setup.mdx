...
llmsDescription: "How to get started with the Jupiter Developer Platform: sign up, create or join a team, generate an API key scoped to that team, and make your first request. API key is passed via x-api-key header; new keys take effect within about 15 seconds. Four tiers available: Free (1 RPS), Developer ($25/mo, 10 RPS), Launch ($100/mo, 50 RPS), Pro ($500/mo, 150 RPS). Keyless access available at 0.5 RPS without sign-up."
---
...
<Steps>
  ...
  <Step>
    Create or join a [team](/portal/organizations) in your organization
  </Step>
  <Step>
