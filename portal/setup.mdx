...
description: "Generate a free API key at portal.jup.ag with Free, Pro, and Ultra tier options."
llmsDescription: "Generate a free API key at portal.jup.ag. Pass it via x-api-key header. Free, Pro, and Ultra tiers available."
---
...
<Steps>
  ...
  <Step>
    ...
    <Card title="Ultra" icon="3" horizontal>
      ...
      <Tip>
        [Using Ultra Swap API comes with many benefits](/ultra) where Jupiter handles the entire end-to-end execution without the need of an RPC from you.
      </Tip>
    </Card>
  </Step>
</Steps>
