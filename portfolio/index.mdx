---
title: "Jupiter Portfolio API Overview"
sidebarTitle: "About Portfolio"
description: "Overview of Jupiter Portfolio API for comprehensive portfolio tracking across the Solana ecosystem"
llmsDescription: "BETA: GET /portfolio/v1/positions?wallet={address} returns all DeFi positions across protocols on Solana including lending, staking, and LP positions."
---
