---
title: "Cancel Order (Recurring V1)"
sidebarTitle: "Cancel Order"
description: "Cancel an active recurring order and reclaim remaining funds."
llmsDescription: "UNMAINTAINED: POST /recurring/v1/cancelOrder cancels an active recurring (DCA) order and returns remaining funds to the user."
---
