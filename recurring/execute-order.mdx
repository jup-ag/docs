---
title: "Execute Order (Recurring V1)"
sidebarTitle: "Execute Order"
description: "Submit a signed recurring order transaction for on-chain execution."
llmsDescription: "UNMAINTAINED: POST /recurring/v1/execute triggers the next cycle of a recurring order. Jupiter keeper bots handle this automatically."
---
...
<Note>
  **INFO**
  ...
  The order id is returned in the [`createOrder` response](/recurring/create-order).
</Note>
