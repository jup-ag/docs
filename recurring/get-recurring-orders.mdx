---
title: "Get Recurring Orders (Recurring V1)"
sidebarTitle: "Get Recurring Orders"
description: "Query active and historical recurring orders by wallet or status."
llmsDescription: "UNMAINTAINED: GET /recurring/v1/getRecurringOrders returns active and historical DCA orders filtered by wallet or status."
---
