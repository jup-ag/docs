---
title: "Recurring (DCA) API Overview"
sidebarTitle: "About Recurring API"
description: "Set up automated dollar-cost averaging (DCA) with time-based recurring orders on Solana."
llmsDescription: "UNMAINTAINED: Overview of the legacy Recurring (DCA) V1 API for automated time-based and price-based recurring token swaps on Solana, superseded by DCA (Trigger V2)."
---
