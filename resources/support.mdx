---
title: "Support"
description: "Technical and customer support platforms for Jupiter"
---
...
<Card href="https://support.jup.ag/requests/new?ticket_form_id=18069133114012&tf_18541841140892=api_or_developer" icon="message" horizontal>
Portal Enquiry
</Card>
<Card href="https://support.jup.ag/requests/new/amm-integrators" icon="shuffle" horizontal>
AMM Integrators
</Card>
</Columns>

Use the AMM Integrators form to submit your DEX for routing integration once your parity tests pass, see [Integrate DEX into Metis](/swap/routing/dex-integration).
...
We are still in the process of finalizing the Swap API customer support process.

Reach out to us in [Discord](https://discord.gg/jup) to discuss what is the best way to support your users.
