...
Use the AMM Integrators form to submit your AMM for routing integration once your parity tests pass, see [Integrate AMM into Metis](/swap/routing/dex-integration).
