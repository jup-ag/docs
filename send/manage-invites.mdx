...
description: "Query pending and historical Send invites for a wallet address."
llmsDescription: "Query pending and historical Send invites using the /send/v1/pending-invites and /send/v1/invite-history endpoints."
---
