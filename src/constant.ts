export const navbarConfigs = {
  "/docs": [
    ...
    { to: "/docs/routing/",
      ...
      position: "left",
      items: [
        { to: "/docs/routing/", label: "About", position: "left" },
        { to: "/docs/routing/dex-integration", label: "DEX Integration", position: "left" },
        { to: "/docs/routing/rfq-integration", label: "RFQ Integration", position: "left" },
      ],
    },
