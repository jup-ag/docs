---
title: "Jupiter Studio Overview"
sidebarTitle: "About Studio"
description: "Jupiter Studio provides APIs for token creation with flexible bonding curves, LP fee management, vesting schedules, and dedicated token pages on jup.ag."
---
...
<Info>
  **READINGS**
  ...
  - General FAQ: [https://docs.jup.ag/user-docs/launch/studio](https://docs.jup.ag/user-docs/launch/studio)
</Info>
...
* You are required to make a PUT request to those endpoints, [you can refer to this section on the usage](/studio/create-token#token-metadata).
