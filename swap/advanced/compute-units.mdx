...
The [Metis Router (Build)](/swap/build) code example demonstrates this in steps 4-5 (kit) with full working code.
...
- [Metis Router (Build)](/swap/build) for the full code example with CU simulation
