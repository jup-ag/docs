...
llmsDescription: "How to use Jupiter's Real-Time Slippage Estimator (RTSE) on both /order and /build endpoints. On /order, RTSE is applied automatically at order time. On /build, pass slippageBps=rtse to opt in. Covers when to use RTSE vs a fixed slippageBps value."
---
