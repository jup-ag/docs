...
## Metis Router vs Meta-Aggregator
...
| **Transaction landing** | Managed via `/execute` | Self-managed or use Jupiter Beam via [`/submit`](/transaction/submit) |
