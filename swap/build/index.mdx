...
Once built and signed, you can submit transactions via your own RPC, or use [`/submit`](/transaction/submit) to land them through Jupiter's transaction infrastructure with SOL tips.
...
| **Transaction landing** | Managed via `/execute` | Self-managed or use our proprietary landing pipeline via [`/submit`](/transaction/submit) |
