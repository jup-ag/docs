...
| **Execution** | Managed via `/execute` (optimised slippage, priority fees, our proprietary landing pipeline) | Self-managed via your own RPC, or via [`/submit`](/swap/submit) with SOL tips for Jupiter Beam landing (our proprietary landing pipeline) |
