...
| **Execution** | Managed via `/execute` (optimised slippage, priority fees, accelerated landing) | Self-managed via your own RPC, or via [`/submit`](/swap/submit) with SOL tips for Jupiter Beam landing |
