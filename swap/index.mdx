...
- **AMM operators**: [Integrate AMM into Metis](/swap/routing/dex-integration) to get your markets included in Jupiter's onchain routing.
- **Market makers**: integrate into JupiterZ to provide off-chain liquidity via the RFQ system, over a [webhook (V1)](/swap/routing/rfq-integration) or [gRPC streams (V2)](/swap/routing/rfq-streaming).
