...
| :--- | :--- | :--- |
| NO\_ROUTES\_FOUND | No routes were found for the requested swap | * Check jup.ag if it's routable <br/> * Check the liquidity of the token's markets <br/> * See [Market Listing](/swap/routing/market-listing) for grace period and liquidity criteria |
| COULD\_NOT\_FIND\_ANY\_ROUTE | Unable to find any valid route for the swap | * Check jup.ag if it's routable <br/> * Check the liquidity of the token's markets <br/> * See [Market Listing](/swap/routing/market-listing) for grace period and liquidity criteria |
