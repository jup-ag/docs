---
title: "Get Quote (Swap V1)"
sidebarTitle: "Get Quote"
description: "Get a swap route quote from the Metis routing engine."
llmsDescription: "UNMAINTAINED: GET /swap/v1/quote returns route plans from the Metis routing engine. Required params: inputMint, outputMint, amount, slippageBps. Covers restrictIntermediateTokens, maxAccounts, onlyDirectRoutes, platformFeeBps, and legacy transaction support."
---
