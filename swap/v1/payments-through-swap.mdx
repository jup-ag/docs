...
<Card title="If transactions are not landing well, you can refer to this section." href="/swap/v1/send-swap-transaction#oh-transaction-not-landing" icon="money-bill" horizontal/>
