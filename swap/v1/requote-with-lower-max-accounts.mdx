...
<Info>
  **NOTE**
  ...
  <CardGroup>
    <Card title="Refer to this section for more information and do note its limitations and important notes before using" href="/swap/v1/get-quote#max-accounts" icon="book-open" horizontal/>
  </CardGroup>
</Info>
