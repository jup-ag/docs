...
description: "Handle oversized swap transactions by reducing the account count in your quote request."
llmsDescription: "UNMAINTAINED: Reduce the maxAccounts quote parameter when adding custom instructions causes the swap transaction to exceed Solana's 1232-byte size limit. Includes a retry loop that decrements maxAccounts until the transaction fits."
---
...
<Info>
  **NOTE**
  ...
  <CardGroup>
    <Card title="Refer to this section for more information and do note its limitations and important notes before using" href="/swap-api/get-quote#max-accounts" icon="book-open" horizontal/>
  </CardGroup>
</Info>
