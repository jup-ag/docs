...
1. Get an API key at [portal.jup.ag](https://portal.jup.ag). All requests require the `x-api-key` header.
...
If you are a known project or launchpad on Solana, DM [@jup_vrfd](https://x.com/jup_vrfd) from your organization account on X. This lets the VRFD team connect your Jupiter Portal OrgId, which adds credibility and supports your submissions.
