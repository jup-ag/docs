...
description: "Powerful developer tools and SDKs that help you integrate Jupiter products into your applications with minimal effort."
llmsDescription: "Three developer tool kits: Jupiter Plugin (drop-in Ultra Swap widget), Wallet Kit (unified wallet adapter for all Solana wallets), and Referral Program (earn fees on user trades)."
---
...
- [Enables Swap API to earn fees](/docs/swap/fees)
</Card>
