---
title: "Jupiter Plugin FAQ"
sidebarTitle: "FAQ"
description: "Frequently asked questions about Jupiter Plugin"
llmsDescription: "Frequently asked questions about Jupiter Plugin: feature requests, adding referral fees, fixing integrated mode layout issues, and best practices for customization."
---
...
<AccordionGroup>
  ...
  <Accordion title="How do I add fees to Plugin?">
    * **Creating Referral Account and Token Accounts**: You can create via [scripts](/ultra/add-fees-to-ultra) or [Referral Dashboard](https://referral.jup.ag).
