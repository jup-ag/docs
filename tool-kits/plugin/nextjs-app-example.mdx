...
description: "Step-by-step guide to integrate Jupiter Plugin into a Next.js application."
llmsDescription: "Step-by-step guide to integrate Jupiter Plugin into a Next.js application using either the window object or the @jup-ag/plugin npm package."
---
