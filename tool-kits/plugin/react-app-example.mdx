...
description: "Step-by-step guide to integrate Jupiter Plugin into a React application."
llmsDescription: "Step-by-step guide to integrate Jupiter Plugin into a React application using either the window object or the @jup-ag/plugin npm package."
---
