...
llmsDescription: "The open-source Referral Program SDK enables developers to earn on-chain fees via Jupiter APIs (Ultra Swap, Swap, Trigger, Plugin) and can be integrated by any Solana program."
---
