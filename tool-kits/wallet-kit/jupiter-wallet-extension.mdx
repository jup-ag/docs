...
description: "Step-by-step guide to integrate Jupiter Wallet Extension into a Next.js application."
llmsDescription: "Step-by-step guide to integrate Jupiter Wallet Extension into a Next.js app using @jup-ag/wallet-adapter with UnifiedWalletProvider and notification handling."
---
    ...
    <UnifiedWalletProvider
      ...
      config={{
        ...
        walletlistExplanation: {
          href: "https://dev.jup.ag/docs/tool-kits/wallet-kit",
        },
        theme: "dark",
        lang: "en",
      }}
