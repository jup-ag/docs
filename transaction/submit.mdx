...
// 2. Assemble instructions (tipInstruction is included in the response)
const instructions = [
...
// 3. Build, sign (see /build docs for full tx assembly, ALTs, and CU simulation)
...
const instructions = [
  ...
  ...(build.tipInstruction ? [createInstruction(build.tipInstruction)] : []),
];
