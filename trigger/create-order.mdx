...
<Warning>
**Action required:** At the end of the week of May 11, 2026, price-order deposits crafted with `POST /trigger/v2/deposit/craft` must include `orderType: "price"` and `orderSubType`. Requests missing either field will return a `4xx`.
</Warning>
