...
| `jlEnabled` / `jlYieldUsd` | Whether [Earn While You Wait](/trigger/dca#earn-while-you-wait) is on, and the yield accrued so far in USD (`null` when not JL-enabled or a required price is uncached). |
