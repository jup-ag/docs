...
| `orderCount` | `number` | Yes | Number of rounds. Minimum 2, no fixed maximum (the per-round \$10 minimum effectively caps it at your deposit in USD ÷ 10). |
...
| :--- | :--- |
| Each round worth ≥ \$10 (`inputAmount ÷ orderCount`, \$0.20 tolerance) | `Each order must be at least 10 USD (current value: X USD)` |
