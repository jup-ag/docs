...
<Note>
  **GET TRIGGER ORDERS**
  ...
  [Refer to the `/getTriggerOrders` section](/trigger/v1/get-trigger-orders) to prepare the list of order accounts you want to cancel.
</Note>
