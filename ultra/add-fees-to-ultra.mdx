...
description: "Add custom integrator fees to Ultra Swap using the Referral Program."
llmsDescription: "UNMAINTAINED: Four-step setup to add custom fees (50–255 bps) to Ultra Swap: install referral SDK, create referralAccount, create referralTokenAccount per mint, then pass referralAccount and referralFee to /order."
---
...
<Note>
    If you are unfamiliar with [Ultra Swap Fees](/ultra/fees), please refer to the doc.
</Note>
...
<AccordionGroup>
    ...
    <Accordion title="Ultra decides which mint to take fees in">
        ...
        <Info>
            The `feeMint` is based on a priority list, you can refer to the [Ultra Fees](/ultra/fees) doc for more details.
