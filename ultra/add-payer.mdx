...
- [Refer to Add Fees to Ultra Swap guide](/ultra/add-fees-to-ultra) for more details on how to set up.
...
Refer to [Solana Docs](https://solana.com/tokens/basics/create-token-account) for more details on the close authority.