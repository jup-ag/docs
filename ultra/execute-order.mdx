---
title: "Execute Order (Ultra)"
sidebarTitle: "Execute Order"
description: "Submit a signed Ultra Swap transaction for execution and receive the swap result."
llmsDescription: "UNMAINTAINED: POST /ultra/v1/execute accepts the signed transaction and requestId, broadcasts it, and returns the swap result."
---
