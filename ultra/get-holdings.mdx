---
title: "Get Holdings (Ultra)"
sidebarTitle: "Get Holdings"
description: "Retrieve detailed token holdings and balances for a wallet address."
llmsDescription: "UNMAINTAINED: GET /ultra/v1/holdings/{address} returns detailed token holdings including token account info, frozen status, and native SOL balance."
---
