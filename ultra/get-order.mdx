---
title: "Get Order (Ultra)"
sidebarTitle: "Get Order"
description: "Request a swap quote and unsigned transaction from the Ultra Swap API."
llmsDescription: "UNMAINTAINED: GET /ultra/v1/order returns a base64-encoded unsigned swap transaction. Required params: inputMint, outputMint, amount, taker."
---
