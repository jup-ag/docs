---
title: "Get Shield (Ultra)"
sidebarTitle: "Get Shield"
description: "Check token security warnings including freeze authority, mint authority, and organic activity signals."
llmsDescription: "UNMAINTAINED: GET /ultra/v1/shield?mints={mints} returns token security warnings (freeze authority, mint authority, low organic activity, etc.) for specified mint addresses."
---
