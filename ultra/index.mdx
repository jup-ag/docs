...
llmsDescription: "UNMAINTAINED: Ultra Swap API overview covering RPC-less, gasless swap flow with automatic slippage optimisation and sub-second transaction landing. Superseded by Swap API V2 at api.jup.ag/swap/v2."
---
...
**Quick launch options:** [Ultra Swap API guide](/ultra/get-started) | [Plugin (drop-in UI)](/tool-kits/plugin)

<CardGroup cols={2}>
    <Card title="Ultra Swap API" icon="code" href="/ultra/get-started">
...
<Callout icon="book-open" color="#FFC107" iconType="regular">[Read our latest blog on Ultra V3](https://developers.jup.ag/blog/ultra-v3).</Callout>
...
For detailed examples and results, see [our Ultra V3 blog post](https://developers.jup.ag/blog/ultra-v3#maximising-executed-price).
</Accordion>
...
* MEV Protection: Routing transactions through our own infrastructure provides:
    ...
    * Reduce risk of sandwich attack vectors - [see our blog post on Ultra's swap volume to value extracted ratio](https://developers.jup.ag/blog/ultra-v3#mev-protection).
</Accordion>
...
| **Integrator Fee**          | Ultra Swap allows you to add custom integrator fees to your transactions, on top of Jupiter's fees. Refer to the [Add Fees To Ultra Swap](/ultra/add-fees-to-ultra) guide for more information.                                                                                                                                            |
...
| | **JupiterZ Gasless** | Market makers cover tx and priority fees<br/>Jupiter gas wallet covers output token account rent if needed | Not applicable |
