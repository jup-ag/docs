---
title: "Integrate Jupiter Plugin (Ultra)"
sidebarTitle: "Integrate Jupiter Plugin"
description: "Seamlessly integrate end-to-end Ultra Swap functionality into any application with just a few lines of code."
llmsDescription: "UNMAINTAINED: Drop-in Ultra Swap UI widget for any web app. Three display modes (integrated, widget, modal), wallet passthrough support, and integrator fee configuration."
---
...
- **Ultra Mode**: Access to all features of Ultra Mode, read more about it in the [Ultra Swap API docs](/ultra/).
...
- **Referral Account**: You can create a referral account via [scripts](/ultra/add-fees-to-ultra) or [Referral Dashboard](https://referral.jup.ag/).
