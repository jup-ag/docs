...
llmsDescription: "UNMAINTAINED: Ultra Swap API response schemas and error codes for /order (errorCode 1–3) and /execute (codes 0, -1 to -5, -1000s aggregator, -2000s RFQ, and program-level codes)."
---
