...
* **`GET /order`**: default path. Returns an assembled transaction with the best price across all routers (Metis, JupiterZ, Hashflow, Dflow, OKX). Includes RTSE, Jupiter Beam, gasless, and RFQ competition. Sign and send to `/execute`.
...
Start with `/order`. It gives the best price because all routers compete, including RFQ market makers who often beat onchain routing on major pairs. Only use `/build` if you need to modify the transaction.

Ultra and Metis APIs remain available. New integrations should use the Swap API, and existing integrations are encouraged to migrate when convenient. See the [migration guide](/docs/swap/v2/migration) for details.

- [Swap API overview](/docs/swap)
- [Order & Execute](/docs/swap/v2/order-and-execute)
- [Build Custom Transactions](/docs/swap/v2/build)
- [Routing](/docs/swap/v2/routing)
- [Fees](/docs/swap/v2/fees)
...
<Card title="Lend Documentation" href="/docs/lend" icon="building-columns" iconType="solid" horizontal/>
...
<Card title="Prediction Market Docs" href="/docs/prediction" icon="magnifying-glass" iconType="solid" horizontal/>
...
<Card title="Manual Mode Docs" href="/docs/ultra/manual-mode" icon="sliders" iconType="solid" horizontal/>
...
<Card title="Portfolio API Docs" href="/docs/portfolio" icon="chart-pie" iconType="solid" horizontal/>
...
* You can find the details in the [Add Fees To Swap](/docs/swap/v1/add-fees-to-swap) guide.
