...
* This will take effect on 31st December 2025.
...
<Card title="Migration Guide" href="/get-started/migrate-from-lite-api" icon="arrow-right" iconType="solid" horizontal/>
